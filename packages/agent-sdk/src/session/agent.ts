...
import type { ContextManager } from '../local/contextManager.js';
...
import { serverNameFromTool } from '../local/SessionRuntimeUtils.js';
...
import { discoverSkills } from '../local/skillsRegistry.js';
...
import { AttachmentHandler } from '../local/AttachmentHandler.js';
...
import type { AgentOptions, LoopOptions } from '../local/agentLoopTypes.js';
import type { ChatContext, UserMessageContent } from '../local/agentTypes.js';
import type { LoopResult } from '../local/agentLoopTypes.js';
import type { PlanApprovalResult } from '../local/agentLoopTypes.js';
...
export class Agent {
  ...
  private getContextWorkingDirectory(context: ChatContext): string | undefined {
    return (context.snapshot as { cwd?: string } | undefined)?.cwd || getContextCwd(this.defaultContext);
  }
