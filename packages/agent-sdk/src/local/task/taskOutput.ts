...
// Port interface for BackgroundAgentManager
interface BackgroundAgentPort {
...
`.trim(),
  ...
  async execute(params, context: ExecutionContext): Promise<ToolResult> {
    ...
    const agentManager = context.backgroundAgentManager as BackgroundAgentPort | undefined;
  ...
  if (!processInfo) {
    return {
      ...
      error: {
        ...
        message: `Shell not found: ${taskId}`,
      },
      metadata: {
        summary: '未找到 Shell',
      },
