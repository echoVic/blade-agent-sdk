 ...
 * 上下文管理模块的核心类型定义
 *
 * Migrated from src/context/types.ts.
 * Imports adjusted to package-local sources:
 *  - branded types from ./branded.js
 *  - JsonObject/JsonValue from @blade-ai/ai
 *  - MessageRole from ./constants.js
 */

import type { MessageId, SessionId } from './branded.js';
import type { JsonObject, JsonValue } from '@blade-ai/ai';
import type { MessageRole } from './constants.js';
