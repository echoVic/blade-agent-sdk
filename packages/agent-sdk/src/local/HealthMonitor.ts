...
import type { McpClientLike } from './mcpTypes.js';
import { McpConnectionStatus } from './mcpTypes.js';
import { HealthStatus } from './mcpHealth.js';
import type { HealthCheckConfig } from './mcpHealth.js';
...
export class HealthMonitor extends EventEmitter {
  ...
  constructor(client: McpClientLike, config: HealthCheckConfig = {}) {
    super();
    this.client = client;
    this.config = {
