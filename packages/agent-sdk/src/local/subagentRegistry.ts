...
import { builtinAgents } from '../subagents/builtinAgents.js';
import type { SubagentConfig, SubagentFrontmatter, SubagentSource } from '../subagents/types.js';
import { mapClaudeCodePermissionMode } from '../subagents/types.js';
