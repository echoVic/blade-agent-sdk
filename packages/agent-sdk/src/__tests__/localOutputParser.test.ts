...
import { OutputParser } from '../local/OutputParser.js';
import type { CommandHook, HookConfig, ProcessResult } from '../local/hookTypes.js';
import { HookType } from '../local/hookTypes.js';
