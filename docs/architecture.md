...
| `@blade-ai/agent-sdk` | session-first 产品 SDK，组合 AI provider、Agent kernel、server/local adapters、MCP、工具、持久化、hooks、observability | 不把 browser-safe API 和 Node-only runtime 混在同一个入口 |
