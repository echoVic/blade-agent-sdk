...
describe('package entrypoints', () => {
  ...
  it('declares production verification scripts for package and release gates', () => {
    expect(rootPackageJson.scripts).toMatchObject({
      ...
      'test:packages': 'pnpm --filter @blade-ai/ai exec vitest run --passWithNoTests && pnpm --filter @blade-ai/agent exec vitest run --passWithNoTests && pnpm --filter @blade-ai/agent-sdk exec vitest run --passWithNoTests',
