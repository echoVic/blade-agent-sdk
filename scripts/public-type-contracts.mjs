...
const sdkPublicTypeImportContracts = {
  localDeclaration: [
    ...
    "import type { SessionTool } from '@blade-ai/agent-sdk';",
    ...
    "import type { Tool as PublicTool } from '@blade-ai/agent-sdk/tools';",
  ...
  packedConsumer: [
    ...
    "import type { SdkErrorOptions } from '@blade-ai/agent-sdk/errors';",
    "import type { ISession as SubpathSession, ResumeOptions, SessionOptions as SubpathSessionOptions, SessionTool as SubpathSessionTool } from '@blade-ai/agent-sdk/session';",
    "import type { ConfirmationHandler as PublicToolsConfirmationHandler, ExecutionContext as PublicToolsExecutionContext, ToolDefinition as ToolsToolDefinition, ToolExecutionOutcome, ToolExecutionUpdate, ToolResult as ToolsToolResult, ToolValidationError as ToolsToolValidationError } from '@blade-ai/agent-sdk/tools';",
    "import type { Tool as PublicTool } from '@blade-ai/agent-sdk/tools';",
    "import { ToolKind as PublicToolsToolKind, createToolBehavior as createPublicToolBehavior } from '@blade-ai/agent-sdk/tools';",
    "import type { ToolBehavior as PublicToolBehavior } from '@blade-ai/agent-sdk/tools';",
  ...
  publishedConsumer: [
    ...
    "import type { StreamMessage as BrowserStreamMessage } from '@blade-ai/agent-sdk/browser';",
    "import type { SdkErrorOptions } from '@blade-ai/agent-sdk/errors';",
    "import type { ISession, SessionTool as PublishedSessionTool } from '@blade-ai/agent-sdk/session';",
    "import type { ClaudeCodePermissionMode, ISession as ServerSession, PermissionsConfig as ServerPermissionsConfig, SubagentExecutionRunner, SubagentFrontmatter } from '@blade-ai/agent-sdk/server';",
    "import type { ConfirmationHandler as PublicToolsConfirmationHandler, ExecutionContext as PublicToolsExecutionContext, ToolDefinition as SubpathToolDefinition, ToolExecutionOutcome, ToolExecutionUpdate, ToolResult as SubpathToolResult, ToolValidationError as SubpathToolValidationError } from '@blade-ai/agent-sdk/tools';",
    "import type { Tool as PublicTool } from '@blade-ai/agent-sdk/tools';",
    "import { ToolKind as PublicToolsToolKind, createToolBehavior as createPublicToolBehavior } from '@blade-ai/agent-sdk/tools';",
    "import type { ToolBehavior as PublicToolBehavior } from '@blade-ai/agent-sdk/tools';",
    "import type { BuiltinToolsOptions } from '@blade-ai/agent-sdk/local';",
